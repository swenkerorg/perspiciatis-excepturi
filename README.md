...
- unpack : parse @swenkerorg/perspiciatis-excepturi buffer into one Object(MBO).
...
```js
npm i @swenkerorg/perspiciatis-excepturi
```

```js
// Node ES Module
import { MBP } from '@swenkerorg/perspiciatis-excepturi'

// Node commonJS
const { MBP } = require('@swenkerorg/perspiciatis-excepturi')
...
- You can use CDN: [jsdelivr](https://www.jsdelivr.com/package/npm/@swenkerorg/perspiciatis-excepturi)  

```html
/* 1. load script first */
<script src="./path/@swenkerorg/perspiciatis-excepturi.min.js"></script>

/* or you can use global CDN url */
<script src="https://cdn.jsdelivr.net/npm/@swenkerorg/perspiciatis-excepturi@1/dist/@swenkerorg/perspiciatis-excepturi.min.js"></script>
...
import { MBP, Buffer } from './path/@swenkerorg/perspiciatis-excepturi.esm.js'
...
- [demo link](https://remocons.github.io/@swenkerorg/perspiciatis-excepturi/example/index.html)
